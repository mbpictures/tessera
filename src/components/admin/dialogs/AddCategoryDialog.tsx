                        ...
                        <Form autoComplete="off" noValidate onSubmit={handleSubmit}>
                            <Stack spacing={2} p={2}>
                                ...
                                <Stack direction={"row"}>
                                    ...
                                    <ColorPicker
                                        value={values.color}
                                        onChange={value => setFieldValue("color", value.css.backgroundColor)}
                                        disableAlpha
                                        hideTextfield
                                    />
                                </Stack>
                                <Stack direction={"row"}>
                                    ...
                                    <ColorPicker
                                        ...
                                        onChange={value => setFieldValue("activeColor", value.css.backgroundColor)}
                                        disableAlpha
                                        hideTextfield
                                    />
                                </Stack>
                                <Stack direction={"row"}>
                                    ...
                                    <ColorPicker
                                        ...
                                        onChange={value => setFieldValue("occupiedColor", value.css.backgroundColor)}
                                        disableAlpha
                                        hideTextfield
                                    />
                                </Stack>
